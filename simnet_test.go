...
func Test701_simnetonly_RoundTrip_SendAndGetReply_SimNet(t *testing.T) {
	...
	onlyBubbled(t, func() { // fast
		...
		//basic SimNet channel based remote procedure call with rpc25519: register a callback on the server, and have the client call it.
...
func Test745_simnetonly_upload(t *testing.T) {
	...
	onlyBubbled(t, func() {
		// upload a large file in parts from client to server
...
func Test755_simnetonly_simnet_download(t *testing.T) {
	...
	onlyBubbled(t, func() {
		...
		// download a large file in parts from server to client, the opposite direction of the previous test.
...
func Test765_simnetonly_bidirectional_download_and_upload(t *testing.T) {
	...
	onlyBubbled(t, func() {
		...
		// we should be able to register a server func that does uploads and downloads sequentially or simultaneously.
...
func Test771_simnetonly_client_dropped_sends(t *testing.T) {
	...
	onlyBubbled(t, func() {
		// simnet client dropped sends should appear in
		// the senders dropped send Q
...
func Test772_simnetonly_server_dropped_sends(t *testing.T) {
	...
	onlyBubbled(t, func() {
		// simnet server dropped sends should
		// appear in the servers dropped send Q
...
func Test781_simnetonly_client_isolated(t *testing.T) {
	...
	onlyBubbled(t, func() {
		// simnet ISOLATED client dropped sends should
		// appear in the client's dropped send Q
...
func Test782_simnetonly_server_isolated(t *testing.T) {
	...
	onlyBubbled(t, func() {
		// simnet ISOLATED server dropped sends should
		// appear in the server's dropped send Q
